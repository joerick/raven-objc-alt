...
{
    RavenConfig *config = [[RavenConfig alloc] initWithDSN:@"http://public_key:secret_key@example.com:8000/project-id"];
    
    XCTAssertNotNil(config, @"Failed to parse DSN");
...
{
    RavenConfig *config = [[RavenConfig alloc] initWithDSN:@"https://public_key:secret_key@example.com/project-id"];
...
{
    RavenConfig *config = [[RavenConfig alloc] initWithDSN:@"http://public_key:secret_key@example.com/project-id"];
